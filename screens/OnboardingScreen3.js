...
const OnboardingScreen3 = () => {
    ...
    const handleNext = () => {
        navigation.navigate('Welcome'); // Last onboarding screen, navigate to Welcome
    };
    ...
    const backgroundImage = categoryImageSources.find(source => source.imageKey === 'woman_presenting_on_stage_ted_style') || categoryImageSources[2];
                    ...
                    <View style={styles.container}>
                        <View style={styles.headerContainer}>
                            ...
                            <Text style={styles.subText}>
                                Build streaks and see your improvement over time.
                            </Text>
                        </View>
