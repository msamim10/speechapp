...
export const promptsData = [
  ...
  },
  {
    ...
    summary:
      "A sample TED Talk script discussing AI’s role in enhancing human creativity, using a personal story of collaborating with AI to compose music. It emphasizes AI as a creative partner and encourages embracing technology.",
    layout: {
      position: "absolute",
      width: "45%",
      height: "35%",
  ...
  },
  {
    ...
    summary:
      "A mock airline safety announcement for a flight, detailing seatbelt use, emergency exits, life vests, and oxygen masks. It’s designed for practicing clear, professional delivery in a high-stakes context.",
    layout: {
      position: "absolute",
      width: "55%",
      height: "35%",
  ...
  },
  {
    ...
    summary:
      "A commencement address celebrating graduates' resilience and critical thinking, urging them to contribute to society and lead with compassion. It highlights overcoming challenges like remote learning.",
    layout: {
      position: "absolute",
      width: "60%",
      height: "50%",
  ...
  },
  {
    ...
    summary:
      "A defense attorney's opening statement asserting the client's innocence, challenging the prosecution's circumstantial evidence, and urging the jury to focus on facts. It's for practicing persuasive legal oratory.",
    layout: {
      position: "absolute",
      width: "60%",
      height: "48%",
  ...
  },
  {
    ...
    summary:
      "A defense attorney's closing statement reinforcing the client's innocence by highlighting inconsistencies in the prosecution's case and lack of conclusive evidence. It emphasizes reasonable doubt and justice.",
    layout: {
      position: "absolute",
      width: "60%",
      height: "35%",
  ...
  },
  {
    ...
    summary:
      "A best man's speech celebrating the couple's love story, offering heartfelt advice on marriage, and toasting their future. It's designed for practicing emotional and engaging delivery.",
    textColor: "white",
    layout: {
      position: "absolute",
      width: "40%",
  ...
  },
  {
    ...
    summary:
      "An introduction to a workshop teaching techniques to overcome public speaking anxiety, structure messages, and engage audiences. It includes practice opportunities and feedback.",
    textColor: "white",
    layout: {
      position: "absolute",
      width: "90%",
  ...
  },
  {
    ...
    summary:
      "A captain's in-flight announcement providing flight details, weather updates, and service information. It's for practicing calm, authoritative communication in a professional setting.",
    layout: {
      position: "absolute",
      width: "50%",
      height: "27%",
  ...
  },
  {
    ...
    summary:
      "A eulogy honoring a community member's kindness and legacy, sharing a story of their impact, and encouraging attendees to carry forward her spirit. It focuses on emotional resonance.",
    layout: {
      position: "absolute",
      width: "58%",
      height: "37%",
  ...
  // --- Practice Fundamentals Prompts ---
  {
    ...
    summary:
      "A simple exercise to practice introducing yourself, focusing on clarity, pace, and personality. It's a foundation for more complex speaking scenarios.",
    layout: {
      position: "absolute",
      width: "60%",
      height: "42%",
  ...
  },
  {
    ...
    summary:
      "A 30-second speech exercise focusing on describing an image, including key details and a natural flow. It's designed for practicing quick thinking and delivery.",
    layout: {
      position: "absolute",
      width: "60%",
      height: "45%",
  ...
  },
  {
    ...
    summary:
      "A panel discussion response discussing the future of remote work, focusing on productivity, company culture, and the role of AI. It's designed for practicing structured, professional delivery.",
    layout: {
      position: "absolute",
      width: "60%",
      height: "33%",
  ...
  },
  {
    ...
    summary:
      "A guide to practicing effective eye contact, avoiding common pitfalls, and making genuine connections with your audience. It emphasizes the importance of eye contact and how to practice it.",
    layout: {
      position: "absolute",
      width: "60%",
      height: "42%",
  ...
  },
  {
    ...
    summary:
      "A guide to using gestures effectively, avoiding common pitfalls, and ensuring they enhance your message. It emphasizes natural, purposeful movement and the importance of variety.",
    layout: {
      position: "absolute",
      width: "60%",
      height: "42%",
  ...
  },
  {
    ...
    summary:
      "A guide to managing filler words, developing awareness, and replacing them with confident pauses. It emphasizes the importance of conscious speech and the impact of filler words.",
    layout: {
      position: "absolute",
      width: "60%",
      height: "39%",
  ...
  },
  {
    ...
    summary:
      "A guide to improving vocal projection, utilizing proper breath support, and ensuring clarity for your entire audience. It emphasizes the importance of proper breathing and projection techniques.",
    layout: {
      position: "absolute",
      width: "60%",
      height: "42%",
  ...
  },
  {
    ...
    summary:
      "A guide to improving speech structure, organizing content logically, and using transitions effectively. It emphasizes the importance of a clear, well-structured speech.",
    layout: {
      position: "absolute",
      width: "60%",
      height: "40%",
  ...
  },
  {
    ...
    summary:
      "A guide to practicing tone modulation, understanding the impact of tone on message delivery, and ensuring it matches the content. It emphasizes the importance of authentic tone and how to practice it.",
    layout: {
      position: "absolute",
      width: "60%",
      height: "43%",
  ...
  },
  {
    ...
    summary:
      "A guide to practicing facial expressions, ensuring they are congruent with your words and tone. It emphasizes the importance of authentic facial expressions and how to practice them.",
    layout: {
      position: "absolute",
      width: "55%",
      height: "33%",
  ...
  },
  {
    ...
    summary:
      "A guide to practicing strategic silence, understanding the importance of pauses, and how to use them effectively. It emphasizes the importance of strategic silence and how to practice it.",
    layout: {
      position: "absolute",
      width: "63%",
      height: "36%",
  ...
  },
  {
    ...
    summary:
      "A guide to enhancing word emphasis, identifying key words, and using subtle vocal techniques to make your delivery more engaging and memorable. It emphasizes the importance of identifying key words and using subtle vocal techniques to make your delivery more engaging and memorable.",
    layout: {
      position: "absolute",
      width: "60%",
      height: "49%",
  ...
  },
  {
    ...
    summary:
      "A guide to building confidence through practice, identifying specific areas for improvement, and visualizing successful delivery. It emphasizes the importance of consistent practice and the role of visualization in building confidence.",
    layout: {
      position: "absolute",
      width: "55%",
      height: "37%",
  ...
  },
  {
    ...
    summary:
      "A thank you speech for a music concert, thanking the sound team, lighting crew, and fans. It emphasizes the importance of live music and the connection between musicians and their audience.",
    layout: {
      position: "absolute",
      width: "60%",
      height: "40%",
  ...
  },
  {
    ...
    summary:
      "A podcast episode discussing the intersection of artificial intelligence and creative arts, featuring Dr. James Morrison. It highlights the groundbreaking work of Dr. Morrison and the potential of AI in enhancing human creativity.",
    layout: {
      position: "absolute",
      width: "60%",
      height: "40%",
  ...
  },
  {
    ...
    summary:
      "A speech encouraging public speaking, emphasizing the importance of mastering breathing and body language, structuring content effectively, and connecting authentically with your audience. It's designed to inspire confidence and effectiveness.",
    layout: {
      position: "absolute",
      width: "60%",
      height: "45%",
  ...
  },
  {
    ...
    summary:
      "A speech encouraging the team to build a legacy of excellence, teamwork, and resilience. It emphasizes the importance of resilience, teamwork, and the pursuit of greatness.",
    layout: {
      position: "absolute",
      width: "60%",
      height: "39%",
  ...
  },
  {
    ...
    summary:
      "A speech discussing the future of human-AI interaction, emphasizing the importance of enhancing human potential rather than replacing it. It emphasizes the importance of creating AI systems that complement human abilities and respect human values.",
    layout: {
      position: "absolute",
      width: "60%",
      height: "38%",
  ...
  },
  {
    ...
    summary:
      "A presentation discussing the Q3 results, emphasizing the importance of innovation, sustainability, and customer experience. It emphasizes the importance of these initiatives and the future of the company.",
    layout: {
      position: "absolute",
      width: "60%",
      height: "42%",
  ...
  },
  {
    ...
    summary:
      "A virtual meeting discussing the digital transformation initiative and its impact on our Q4 targets. It emphasizes the importance of innovation, sustainability, and customer experience. It emphasizes the importance of these initiatives and the future of the company.",
    layout: {
      position: "absolute",
      width: "60%",
      height: "45%",
  ...
  },
  {
    ...
    summary:
      "A thank you speech for an opera performance, thanking the orchestra, cast, technical crew, costume department, and volunteers. It emphasizes the importance of the arts and the importance of supporting the arts.",
    layout: {
      position: "absolute",
      width: "60%",
      height: "34%",
  ...
  },
  {
    ...
    summary:
      "A speech discussing the importance of nature's resilience and the importance of preserving our planet's biodiversity. It emphasizes the importance of cooperation, adaptation, and long-term thinking.",
    layout: {
      position: "absolute",
      width: "55%",
      height: "34%",
  ...
  },
  {
    ...
    summary:
      "A speech discussing the importance of infrastructure and the importance of bipartisan solutions. It emphasizes the importance of infrastructure and the importance of bipartisan solutions.",
    layout: {
      position: "absolute",
      width: "60%",
      height: "38%",
  ...
  // 3. Customize placeholder `title`, `text`, and `layout` for each prompt.
  {
    ...
    summary:
      "A speech discussing the future of cloud computing, emphasizing the importance of AI, security, and infrastructure. It emphasizes the importance of these technologies and the importance of innovation.",
  ...
  },
  {
    ...
    summary:
      "A speech discussing the Q4 earnings call, emphasizing the importance of strategic investments, revenue growth, and efficiency initiatives. It emphasizes the importance of these initiatives and the future of the company.",
    soundAsset: SOUND_CLAPPING,
  ...
  },
  {
    ...
    summary:
      "A speech discussing the startup EcoCharge, emphasizing the importance of solving a critical problem, securing partnerships, and raising funding. It emphasizes the importance of these initiatives and the future of the company.",
    soundAsset: SOUND_CLAPPING,
  ...
  },
  {
    ...
    summary:
      "A speech discussing the new products from Apple, emphasizing the importance of performance, sustainability, and user experience. It emphasizes the importance of these technologies and the importance of innovation.",
    soundAsset: SOUND_CLAPPING,
  ...
  },
  {
    ...
    summary:
      "A speech discussing the power of faith in challenging times, emphasizing the importance of faith, hope, and love. It emphasizes the importance of faith and the importance of hope.",
    soundAsset: SOUND_CLAPPING,
  ...
  },
  {
    ...
    summary:
      "A speech discussing the power of resilience, emphasizing the importance of resilience, failure, and the importance of learning from failure. It emphasizes the importance of resilience and the importance of learning from failure.",
    soundAsset: SOUND_CLAPPING,
  ...
  },
  {
    ...
    summary:
      "A speech discussing the importance of climate change, emphasizing the importance of climate change, global inequality, and the threat of conflict. It emphasizes the importance of climate change and the importance of global inequality.",
    soundAsset: SOUND_CLAPPING,
  ...
  },
  {
    ...
    summary:
      "A speech discussing the importance of community, emphasizing the importance of community, the importance of education, and the importance of healthcare. It emphasizes the importance of community and the importance of education.",
    soundAsset: SOUND_CLAPPING,
  ...
  },
  {
    ...
    summary:
      "A speech discussing the importance of communion, emphasizing the importance of communion, the importance of Christ's sacrifice, and the importance of the body of Christ. It emphasizes the importance of communion and the importance of the body of Christ.",
    soundAsset: SOUND_CLAPPING,
  ...
  },
  {
    ...
    summary:
      "A speech discussing the importance of art, emphasizing the importance of art, the importance of technology, and the importance of the intersection of art and technology. It emphasizes the importance of art and the importance of technology.",
    soundAsset: SOUND_CLAPPING,
  ...
  },
  {
    ...
    summary:
      "A speech discussing the importance of books, emphasizing the importance of books, the importance of reading, and the importance of the written word. It emphasizes the importance of books and the importance of reading.",
    soundAsset: SOUND_CLAPPING,
  ...
  },
  {
    ...
    summary:
      "A speech discussing the importance of teamwork, emphasizing the importance of teamwork, the importance of discipline, and the importance of determination. It emphasizes the importance of teamwork and the importance of discipline.",
    soundAsset: SOUND_CLAPPING,
  ...
  },
  {
    ...
    summary:
      "A speech discussing the importance of space exploration, emphasizing the importance of space exploration, the importance of NASA, and the importance of the future of space exploration. It emphasizes the importance of space exploration and the importance of NASA.",
    soundAsset: SOUND_CLAPPING,
  ...
  },
  {
    ...
    summary:
      "A speech discussing the importance of the monument, emphasizing the importance of the monument, the importance of the sunrise, and the importance of the future of the monument. It emphasizes the importance of the monument and the importance of the sunrise.",
    soundAsset: SOUND_CLAPPING,
  ...
  },
  {
    ...
    summary:
      "A speech discussing the importance of the rally, emphasizing the importance of the rally, the importance of the rally, and the importance of the future of the rally. It emphasizes the importance of the rally and the importance of the rally.",
    soundAsset: SOUND_CLAPPING,
  ...
  },
  {
    ...
    summary:
      "A speech discussing the importance of the UN General Assembly, emphasizing the importance of the UN General Assembly, the importance of the UN General Assembly, and the importance of the future of the UN General Assembly. It emphasizes the importance of the UN General Assembly and the importance of the UN General Assembly.",
    soundAsset: SOUND_CLAPPING,
  ...
  },
  {
    ...
    summary:
      "A speech discussing the importance of the awards ceremony, emphasizing the importance of the awards ceremony, the importance of the awards ceremony, and the importance of the future of the awards ceremony. It emphasizes the importance of the awards ceremony and the importance of the awards ceremony.",
    soundAsset: SOUND_CLAPPING,
  ...
  },
  {
    ...
    summary:
      "A speech discussing the importance of the courtroom, emphasizing the importance of the courtroom, the importance of the courtroom, and the importance of the future of the courtroom. It emphasizes the importance of the courtroom and the importance of the courtroom.",
    soundAsset: SOUND_CLAPPING,
  ...
  },
  {
    ...
    summary:
      "A speech discussing the importance of the TED Talk, emphasizing the importance of the TED Talk, the importance of the TED Talk, and the importance of the future of the TED Talk. It emphasizes the importance of the TED Talk and the importance of the TED Talk.",
    soundAsset: SOUND_CLAPPING,
  ...
  },
  {
    ...
    summary:
      "A speech discussing the importance of the memorial church, emphasizing the importance of the memorial church, the importance of the memorial church, and the importance of the future of the memorial church. It emphasizes the importance of the memorial church and the importance of the memorial church.",
    soundAsset: SOUND_CLAPPING,
  ...
  },
  {
    ...
    summary:
      "A speech discussing the importance of the democratic rally, emphasizing the importance of the democratic rally, the importance of the democratic rally, and the importance of the future of the democratic rally. It emphasizes the importance of the democratic rally and the importance of the democratic rally.",
    soundAsset: SOUND_CLAPPING,
  ...
  },
  {
    ...
    summary:
      "A speech discussing the importance of the unity through faith address, emphasizing the importance of the unity through faith address, the importance of the unity through faith address, and the importance of the future of the unity through faith address. It emphasizes the importance of the unity through faith address and the importance of the unity through faith address.",
    soundAsset: SOUND_CLAPPING,
  ...
  },
  {
    ...
    summary:
      "A speech discussing the importance of the community empowerment rally, emphasizing the importance of the community empowerment rally, the importance of the community empowerment rally, and the importance of the future of the community empowerment rally. It emphasizes the importance of the community empowerment rally and the importance of the community empowerment rally.",
    soundAsset: SOUND_CLAPPING,
  ...
  },
  {
    ...
    summary:
      "A speech discussing the importance of the gallery hall press briefing, emphasizing the importance of the gallery hall press briefing, the importance of the gallery hall press briefing, and the importance of the future of the gallery hall press briefing. It emphasizes the importance of the gallery hall press briefing and the importance of the gallery hall press briefing.",
    soundAsset: SOUND_CLAPPING,
  ...
  },
  {
    ...
    category: "Speeches",
    summary:
      "A speech discussing the importance of the intimate club talk, emphasizing the importance of the intimate club talk, the importance of the intimate club talk, and the importance of the future of the intimate club talk. It emphasizes the importance of the intimate club talk and the importance of the intimate club talk.",
  ...
  },
  {
    ...
    category: "Speeches",
    summary:
      "A speech for a late night talk show appearance that balances humor with meaningful insights, discussing personal experiences and the power of shared laughter to bridge divides. The speech emphasizes the importance of human connection and finding common ground through storytelling and humor, while acknowledging the serious challenges facing society.",
  ...
  },
  {
    ...
    category: "Speeches",
    summary:
      "A dedication speech at the opening of a new wing of the Civil Rights Museum in Atlanta, emphasizing the city's pivotal role in the civil rights movement, honoring both famous leaders and unsung heroes, and connecting historical struggles to ongoing work for justice. The speech highlights Atlanta's significance as the home of Martin Luther King Jr. and SNCC while emphasizing that civil rights progress requires continuous commitment.",
  ...
  },
  {
    ...
    category: "Speeches",
    summary:
      "A solemn speech delivered at a military funeral, honoring a fallen service member's dedication, sacrifice, and character. The speech acknowledges both the dramatic and everyday aspects of military courage, offers comfort to the grieving family, and emphasizes the lasting impact of their service while promising to preserve their memory. The tone balances formal military respect with personal warmth.",
  ...
  },
  {
    ...
    summary:
      "A weekly engineering sync meeting update, covering progress on key initiatives, upcoming deadlines, and team performance. The presentation emphasizes clear communication of project status, highlights team achievements, and encourages open discussion for continuous improvement.",
    category: "Presentations",
  ...
  },
  {
    ...
    summary:
      "A casual team meeting where team members share stories about how their work is making an impact. The presentation emphasizes the importance of innovation and making a difference, while encouraging open discussion and collaboration.",
    category: "Presentations",
  ...
  },
  {
    ...
    summary:
      "A design thinking workshop where participants learn to solve complex problems through creative collaboration. The presentation emphasizes the importance of empathy, problem-solving, and teamwork, while encouraging participants to think outside the box and come up with innovative solutions.",
    category: "Presentations",
  ...
  },
  {
    ...
    summary:
      "A strategic alignment session at Google, focusing on the company's priorities, product roadmap, and leadership goals. The presentation emphasizes the importance of AI, sustainability, and product accessibility, while highlighting the company's commitment to responsible innovation and global reach.",
    category: "Presentations",
  ...
  },
  {
    ...
    summary:
      "A venture capital pitch for a startup that is revolutionizing logistics in Southeast Asia. The presentation emphasizes the company's unique value proposition, market opportunity, and competitive advantage, while highlighting the team's expertise and the potential for significant growth.",
    category: "Presentations",
  ...
  },
  {
    ...
    summary:
      "A grand rounds discussing the importance of multi-drug-resistant infections in a post-transplant patient, emphasizing the importance of multi-drug-resistant infections in a post-transplant patient, the importance of multi-drug-resistant infections in a post-transplant patient, and the importance of multi-drug-resistant infections in a post-transplant patient. It emphasizes the importance of multi-drug-resistant infections in a post-transplant patient and the importance of multi-drug-resistant infections in a post-transplant patient.",
    category: "Presentations",
  ...
  },
  {
    ...
    summary:
      "A policy conference discussing the importance of cross-border collaboration in climate response policy, emphasizing the importance of cross-border collaboration in climate response policy, the importance of cross-border collaboration in climate response policy, and the importance of cross-border collaboration in climate response policy. It emphasizes the importance of cross-border collaboration in climate response policy and the importance of cross-border collaboration in climate response policy.",
    category: "Presentations",
  ...
  },
  {
    ...
    summary:
      "A NYSE IPO bell briefing discussing the importance of the IPO, emphasizing the importance of the IPO, the importance of the IPO, and the importance of the IPO. It emphasizes the importance of the IPO and the importance of the IPO.",
    category: "Presentations",
  ...
  },
  {
    ...
    title: "Hospital Grand Rounds",
    summary:
      "A hospital grand rounds discussing the importance of the hospital grand rounds, emphasizing the importance of the hospital grand rounds, the importance of the hospital grand rounds, and the importance of the hospital grand rounds. It emphasizes the importance of the hospital grand rounds and the importance of the hospital grand rounds.",
    category: "Presentations",
  ...
  },
  {
    ...
    summary:
      "A university poster session discussing the importance of the university poster session, emphasizing the importance of the university poster session, the importance of the university poster session, and the importance of the university poster session. It emphasizes the importance of the university poster session and the importance of the university poster session.",
    category: "Presentations",
    image: require("../assets/presentationpics/ChatGPT Image Apr 29, 2025, 01_12_19 PM.png"),
    soundAsset: SOUND_PRESENTATION,
  ...
  },
  {
    ...
    summary:
      "A LinkedIn industry insights session discussing the importance of the industry insights session, emphasizing the importance of the industry insights session, the importance of the industry insights session, and the importance of the industry insights session. It emphasizes the importance of the industry insights session and the importance of the industry insights session.",
    category: "Presentations",
  ...
  },
  {
    ...
    summary:
      "A Tesla research review discussing the importance of the Tesla research review, emphasizing the importance of the Tesla research review, the importance of the Tesla research review, and the importance of the Tesla research review. It emphasizes the importance of the Tesla research review and the importance of the Tesla research review.",
    category: "Presentations",
  ...
  },
  {
    ...
    summary:
      "A Netflix subscriber trends session discussing the importance of the Netflix subscriber trends session, emphasizing the importance of the Netflix subscriber trends session, the importance of the Netflix subscriber trends session, and the importance of the Netflix subscriber trends session. It emphasizes the importance of the Netflix subscriber trends session and the importance of the Netflix subscriber trends session.",
    category: "Presentations",
  ...
  },
  {
    ...
    summary:
      "A Stanford design thinking workshop discussing the importance of the design thinking workshop, emphasizing the importance of the design thinking workshop, the importance of the design thinking workshop, and the importance of the design thinking workshop. It emphasizes the importance of the design thinking workshop and the importance of the design thinking workshop.",
    category: "Presentations",
  ...
  },
  {
    ...
    summary:
      "A Slack feature rollout review discussing the importance of the feature rollout review, emphasizing the importance of the feature rollout review, the importance of the feature rollout review, and the importance of the feature rollout review. It emphasizes the importance of the feature rollout review and the importance of the feature rollout review.",
    category: "Presentations",
  ...
  },
  {
    ...
    summary:
      "A NOAA climate policy briefing discussing the importance of the climate policy briefing, emphasizing the importance of the climate policy briefing, the importance of the climate policy briefing, and the importance of the climate policy briefing. It emphasizes the importance of the climate policy briefing and the importance of the climate policy briefing.",
    category: "Presentations",
  ...
  },
  {
    ...
    summary:
      "A Department of Homeland Security cyber briefing discussing the importance of the cyber briefing, emphasizing the importance of the cyber briefing, the importance of the cyber briefing, and the importance of the cyber briefing. It emphasizes the importance of the cyber briefing and the importance of the cyber briefing.",
    category: "Presentations",
  ...
  },
  {
    ...
    summary:
      "A Meta policy review briefing discussing the importance of the policy review briefing, emphasizing the importance of the policy review briefing, the importance of the policy review briefing, and the importance of the policy review briefing. It emphasizes the importance of the policy review briefing and the importance of the policy review briefing.",
    category: "Presentations",
  ...
  },
  {
    ...
    summary:
      "A Amazon Robotics all-hands discussing the importance of the all-hands, emphasizing the importance of the all-hands, the importance of the all-hands, and the importance of the all-hands. It emphasizes the importance of the all-hands and the importance of the all-hands.",
    category: "Presentations",
  ...
  },
  {
    ...
    summary:
      "A Dropbox product strategy sync discussing the importance of the product strategy sync, emphasizing the importance of the product strategy sync, the importance of the product strategy sync, and the importance of the product strategy sync. It emphasizes the importance of the product strategy sync and the importance of the product strategy sync.",
    category: "Presentations",
  ...
  // --- Interview Prompts (Placeholders - Customize details below!) ---
  {
    ...
    summary:
      "A technical interview for a Google networking position covering personal background, interest in the role, and teamwork experience. The candidate discusses their full-stack development experience, passion for networking technology, and collaborative approach to team development.",
    category: "Interviews",
  ...
  },
  {
    ...
    summary:
      "A TV presenter interview covering personal background, interest in broadcasting, and preparation for live broadcasts. The candidate discusses their experience as a news reporter, their passion for connecting with audiences, and their preparation routine for live broadcasts.",
    category: "Interviews",
  ...
  },
  {
    ...
    summary:
      "A business analyst interview covering the candidate's approach to gathering and analyzing business requirements, handling conflicting requirements, and a challenging project they worked on.",
    category: "Interviews",
  ...
  },
  {
    ...
    summary:
      "A marketing manager interview covering the candidate's approach to developing a marketing strategy, measuring campaign success, and staying updated with marketing trends.",
    category: "Interviews",
  ...
  },
  {
    ...
    summary:
      "A news reporter interview covering the candidate's approach to verifying the accuracy of their sources, handling breaking news situations, and building relationships with sources.",
    category: "Interviews",
  ...
  },
  {
    ...
    summary:
      "A one to one interview covering the candidate's greatest strengths, their vision for the future, and how they handle work-life balance.",
    category: "Interviews",
  ...
  },
  {
    ...
    summary:
      "A final interview with the CEO covering the candidate's vision for the company, how they handle company-wide challenges, and what value they can bring to the executive team.",
    category: "Interviews",
  ...
  },
  {
    ...
    summary:
      "A doctor interview covering the candidate's approach to handling difficult patient cases, staying current with medical advancements, and handling ethical dilemmas in medicine.",
    category: "Interviews",
  ...
  },
  {
    ...
    summary:
      "A live TV interview covering the candidate's approach to handling unexpected situations during live broadcasts, their preparation routine for live broadcasts, and their ability to remain calm under pressure.",
    category: "Interviews",
  ...
  },
  {
    ...
    summary:
      "A technical panel interview covering the candidate's approach to debugging a critical production issue, their experience with system design interviews, and their ability to give technical feedback.",
    category: "Interviews",
  ...
  },
  {
    ...
    summary:
      "A hiring committee review covering the candidate's approach to disagreeing with a team decision, their approach to measuring project success, and their ability to handle stakeholder misalignment.",
    category: "Interviews",
  ...
  },
  {
    ...
    summary:
      "A coffee chat interview covering the candidate's approach to working in a team environment, their ability to handle disagreements in informal settings, and something fun or unexpected about them.",
    category: "Interviews",
  ...
  },
  {
    ...
    summary:
      "A whiteboard coding challenge covering the candidate's approach to solving a problem, their approach to technical assessments, and their ability to manage their time during live challenges.",
    category: "Interviews",
  ...
  },
  {
    ...
    summary:
      "A behavioral screening interview covering the candidate's approach to overcoming a big challenge, their approach to staying motivated during repetitive tasks, and their ability to handle constructive criticism.",
    category: "Interviews",
  ...
  },
  {
    ...
    summary:
      "An HR screening round covering the candidate's interest in the position, their salary expectations, and their availability to start.",
    category: "Interviews",
  ...
  },
  {
    ...
    summary:
      "A virtual interview setup covering the candidate's approach to preparing for virtual interviews, their experience working remotely, and their tips for video interview etiquette.",
    category: "Interviews",
  ...
  },
  {
    ...
    summary:
      "A recruiter discussion at a career fair covering the candidate's interest in the company, their most proud achievement, and their availability to start.",
    category: "Interviews",
  ...
  },
  {
    ...
    summary:
      "A product manager chat at Google Lounge covering the candidate's approach to product strategy, handling conflicting stakeholder priorities, and ensuring product quality.",
    category: "Interviews",
  ...
  },
  {
    ...
    summary:
      "A live TV interview set covering the candidate's approach to staying composed on live TV, their biggest risk professionally, and their preparation for tricky or controversial questions.",
    category: "Interviews",
  ...
  },
  {
    ...
    summary:
      "A white house policy discussion covering the candidate's approach to improving national security, supporting economic growth, and international cooperation.",
    category: "Interviews",
  ...
  },
  {
    ...
    summary:
      "A volunteer program interview covering the candidate's interest in volunteering, their experience with volunteering, and how they would handle challenging situations during volunteering.",
    category: "Interviews",
  ...
  },
  {
    ...
    summary:
      "An academic panel interview covering the candidate's approach to managing classroom diversity, using innovative teaching methods, and assessing student progress.",
    category: "Interviews",
  ...
  },
  {
    ...
    summary:
      "A factory floor interview covering the candidate's approach to ensuring production efficiency, maintaining machinery, and working on the factory floor.",
    category: "Interviews",
  ...
  },
  {
    ...
    summary:
      "A cafe business meeting covering the candidate's key business priorities for this year, maintaining client relationships, and overcoming significant business challenges.",
    category: "Interviews",
  ...
  },
  {
    ...
    summary:
      "An enterprise strategy meeting at IBM HQ covering IBM's key innovation priorities, approaching digital transformation for clients, and mitigating risks associated with legacy systems.",
    category: "Interviews",
  ...
  },
  {
    ...
    summary:
      "A content creator pitch at YouTube Studio covering the candidate's approach to content creation, their experience with content creation, and their ability to create engaging content.",
    category: "Interviews",
  ...
  },
  {
    ...
    summary:
      "A recruiter screening interview covering the candidate's approach to evaluating candidates, their ability to remain impartial during high-volume recruitment, and their ability to handle high-volume recruitment effectively.",
    category: "Interviews",
  ...
  },
  {
    ...
    summary:
      "A Disney Imagineering technical review covering the candidate's approach to balancing storytelling with engineering constraints, their experience with themed experiences, and their ability to validate guest interaction flows.",
    category: "Interviews",
  ...
  },
  {
    ...
    summary:
      "A talent assessment at a corporate office covering the candidate's approach to designing fair assessment exercises, their ability to measure candidate performance objectively, and their ability to provide feedback to unsuccessful candidates.",
    category: "Interviews",
...

  {
    ...
    summary:
      "An executive panel discussion in Chicago covering the candidate's approach to driving metropolitan corporate strategy, their ability to navigate regional regulatory challenges, and their ability to leverage city resources for growth.",
    category: "Interviews",
  ...
  },
  {
    ...
    summary:
      "A regulatory hearing at a federal agency covering the candidate's approach to ensuring policy compliance across departments, their ability to balance security interests with individual privacy, and their ability to maintain public accountability.",
    category: "Interviews",
  ...
  },
  {
    ...
    summary:
      "A regional operations interview at Home Depot Atlanta HQ covering the candidate's approach to optimizing supply chain efficiency regionally, their ability to manage seasonal demand fluctuations, and their ability to ensure brand consistency across stores.",
    category: "Interviews",
  ...
  },
  {
    ...
    summary:
      "A cloud solutions architect interview at Microsoft covering the candidate's approach to designing scalable cloud architectures, their ability to ensure data security in the cloud, and their ability to optimize cloud costs for enterprise clients.",
    category: "Interviews",
  ...
  },
  {
    ...
    summary:
      "A financial analyst interview at Bloomberg covering the candidate's approach to analyzing market trends effectively, their ability to communicate complex insights to stakeholders, and their ability to ensure data accuracy under tight deadlines.",
    category: "Interviews",
  ...
  },
  {
    ...
    summary:
      "An environmental policy advisor interview covering the candidate's approach to developing sustainable environmental policies, measuring environmental impact, and engaging communities in policy adoption.",
    category: "Interviews",
  ...
  },
  {
    ...
    summary:
      "A medical ethics panel at Johns Hopkins Medical Center covering the candidate's approach to patient informed consent, balancing research innovation with patient care, and safeguarding clinical trial integrity.",
    category: "Interviews",
  ...
  },
  {
    ...
    summary:
      "A brand strategy discussion at Starbucks HQ covering the candidate's approach to maintaining brand loyalty globally, their approach to digital engagement, and their approach to responsible expansion.",
    category: "Interviews",
  ...
  },
  {
    ...
    summary:
      "A social media strategist interview at Snap Inc. covering the candidate's approach to driving user engagement on social platforms, their strategy for monetizing content, and their approach to protecting user data privacy.",
    category: "Interviews",
  ...
  },
  {
    ...
    summary:
      "An executive education director interview at Harvard Business School covering the candidate's approach to designing executive education curricula, measuring participant outcomes, and adapting programs for evolving market needs.",
    category: "Interviews",
  ...
  // 3. Customize placeholder `title`, `text`, and `layout` for each prompt.
  {
    ...
    summary:
      "A student academic progress discussion covering the candidate's approach to improving writing skills, attending writing workshops, and setting up a study schedule for research projects.",
  ...
  },
  {
    ...
    summary:
      "A firefighter training session covering the candidate's approach to high-rise building fire scenarios, checking oxygen levels before entry, and following established evacuation procedures.",
    category: "Situational/Specific",
  ...
  },
  {
    ...
    title: "Museum Guide",
    summary:
      "A museum guide session covering the candidate's approach to exploring modern art history, appreciating artwork, and following safety guidelines.",
    category: "Situational/Specific",
  ...
  },
  {
    ...
    summary:
      "A fighter jet guide session covering the candidate's approach to exploring the F-35 Lightning II, understanding its advanced capabilities, and following safety protocols.",
    category: "Situational/Specific",
  ...
  },
  {
    ...
    summary:
      "A safari park guide session covering the candidate's approach to exploring the savanna habitat, encountering animals, and following safety guidelines.",
    category: "Situational/Specific",
  ...
  },
  {
    ...
    summary:
      "A customer complaint handling session covering the candidate's approach to understanding the customer's issue, apologizing for the inconvenience, and offering a solution.",
    category: "Situational/Specific",
  ...
  },
  {
    ...
    summary:
      "A constructive feedback session covering the candidate's approach to providing feedback to a peer, highlighting strengths and areas for improvement, and offering suggestions for improvement.",
    category: "Situational/Specific",
  ...
  },
  {
    ...
    summary:
      "A technical issue explanation session covering the candidate's approach to explaining a technical issue to a non-technical manager, using a simple analogy to help the manager understand the issue.",
    category: "Situational/Specific",
  ...
  },
  {
    ...
    summary:
      "A raise or promotion request session covering the candidate's approach to asking for a raise or promotion, highlighting their achievements, and offering suggestions for improvement.",
    category: "Situational/Specific",
  ...
  },
  {
    ...
    summary:
      "A decline of an unreasonable request session covering the candidate's approach to declining an unreasonable request, highlighting their current workload, and offering suggestions for improvement.",
    category: "Situational/Specific",
  ...
  },
  {
    ...
    summary:
      "A bad news delivery session covering the candidate's approach to delivering bad news to a client, highlighting the unexpected technical challenge, and offering a mitigation plan.",
    category: "Situational/Specific",
  ...
  },
  {
    ...
    summary:
      "A persuasive session covering the candidate's approach to persuading stakeholders to adopt a new process, highlighting the benefits of the new process, and offering a phased implementation plan.",
    category: "Situational/Specific",
  ...
  },
  {
    ...
    summary:
      "An apology session covering the candidate's approach to apologizing for a mistake, highlighting the importance of accuracy in reports, and offering a solution to prevent the mistake from happening again.",
    category: "Situational/Specific",
  ...
  },
  {
    ...
    summary:
      "A stand-up meeting session covering the candidate's approach to running a quick stand-up meeting, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
    category: "Situational/Specific",
  ...
  },
  {
    ...
    summary:
      "A storm update press briefing session covering the candidate's approach to running a storm update press briefing, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
    category: "Situational/Specific",
  ...
  },
  {
    ...
    summary:
      "A NORAD command center briefing session covering the candidate's approach to running a NORAD command center briefing, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
    category: "Situational/Specific",
  ...
  },
  {
    ...
    summary:
      "A rocket launch site crew coordination session covering the candidate's approach to running a rocket launch site crew coordination, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
    category: "Situational/Specific",
  ...
  },
  {
    ...
    summary:
      "A team locker room pre-game huddle session covering the candidate's approach to running a team locker room pre-game huddle, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
    category: "Situational/Specific",
  ...
  },
  {
    ...
    summary:
      "A disaster relief coordination meeting session covering the candidate's approach to running a disaster relief coordination meeting, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
    category: "Situational/Specific",
  ...
  },
  {
    ...
    summary:
      "A pandemic drill emergency response session covering the candidate's approach to running a pandemic drill emergency response, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
    category: "Situational/Specific",
  ...
  },
  {
    ...
    summary:
      "A warehouse operations coordination session covering the candidate's approach to running a warehouse operations coordination, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
    category: "Situational/Specific",
  ...
  },
  {
    ...
    summary:
      "Aerial firefighting deployment brief session covering the candidate's approach to running an aerial firefighting deployment brief, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
    category: "Situational/Specific",
  ...
  },
  {
    ...
    summary:
      "A national park ranger briefing session covering the candidate's approach to running a national park ranger briefing, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
    category: "Situational/Specific",
  ...
  },
  {
    ...
    summary:
      "An airport ground operations coordination session covering the candidate's approach to running an airport ground operations coordination, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
    category: "Situational/Specific",
  ...
  // 3. Customize placeholder `title`, `text`, and `layout` for each prompt.
  {
    ...
    summary:
      "A couple social scene covering the candidate's approach to running a couple social scene, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
  ...
  },
  {
    ...
    summary:
      "An office social scene covering the candidate's approach to running an office social scene, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
    category: "Social & Casual",
  ...
  },
  {
    ...
    summary:
      "A family social scene covering the candidate's approach to running a family social scene, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
    category: "Social & Casual",
  ...
  },
  {
    ...
    summary:
      "A library social scene covering the candidate's approach to running a library social scene, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
    category: "Social & Casual",
  ...
  },
  {
    ...
    summary:
      "A networking event small talk covering the candidate's approach to running a networking event small talk, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
    category: "Social & Casual",
  ...
  },
  {
    ...
    summary:
      "A catching up with a friend covering the candidate's approach to running a catching up with a friend, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
    category: "Social & Casual",
  ...
  },
  {
    ...
    summary:
      "A meeting a neighbor covering the candidate's approach to running a meeting a neighbor, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
    category: "Social & Casual",
  ...
  },
  {
    ...
    summary:
      "A casual coffee break chat (work) covering the candidate's approach to running a casual coffee break chat (work), highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
    category: "Social & Casual",
  ...
  },
  {
    ...
    summary:
      "A joining a group conversation covering the candidate's approach to running a joining a group conversation, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
    category: "Social & Casual",
  ...
  },
  {
    ...
    summary:
      "A making plans with an acquaintance covering the candidate's approach to running a making plans with an acquaintance, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
    category: "Social & Casual",
  ...
  },
  {
    ...
    summary:
      "A discussing hobbies/interests covering the candidate's approach to running a discussing hobbies/interests, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
    category: "Social & Casual",
  ...
  },
  {
    ...
    summary:
      "A giving a casual compliment covering the candidate's approach to running a giving a casual compliment, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
    category: "Social & Casual",
  ...
  },
  {
    ...
    summary:
      "An ending a conversation politely covering the candidate's approach to running an ending a conversation politely, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
    category: "Social & Casual",
  ...
  },
  {
    ...
    summary:
      "A reacting to shared news (good/bad) covering the candidate's approach to running a reacting to shared news (good/bad), highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
    category: "Social & Casual",
  ...
  },
  {
    ...
    summary:
      "A campfire story night covering the candidate's approach to running a campfire story night, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
    category: "Social & Casual",
  ...
  },
  {
    ...
    summary:
      "A thanksgiving toast covering the candidate's approach to running a thanksgiving toast, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
    category: "Social & Casual",
  ...
  },
  {
    ...
    summary:
      "An outdoor movie night welcome covering the candidate's approach to running an outdoor movie night welcome, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
    category: "Social & Casual",
  ...
  },
  {
    ...
    summary:
      "A cabin game night kickoff covering the candidate's approach to running a cabin game night kickoff, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
    category: "Social & Casual",
  ...
  },
  {
    ...
    summary:
      "A brewery brainstorm session covering the candidate's approach to running a brewery brainstorm session, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
    category: "Social & Casual",
  ...
  },
  {
    ...
    summary:
      "A festival meet-up greeting covering the candidate's approach to running a festival meet-up greeting, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
    category: "Social & Casual",
  ...
  },
  {
    ...
    summary:
      "A dorm game night starter covering the candidate's approach to running a dorm game night starter, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
    category: "Social & Casual",
  ...
  },
  {
    ...
    summary:
      "A porch group catch-up covering the candidate's approach to running a porch group catch-up, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
    category: "Social & Casual",
  ...
  },
  {
    ...
    summary:
      "A fairground food talk covering the candidate's approach to running a fairground food talk, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
    category: "Social & Casual",
  ...
  },
  {
    ...
    summary:
      "A rooftop wine conversation covering the candidate's approach to running a rooftop wine conversation, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
    category: "Social & Casual",
  ...
  // --- Virtual Communication Prompts ---
  {
    ...
    summary:
      "A quarterly project update & next steps covering the candidate's approach to running a quarterly project update & next steps, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
    ...
    layout: {
      // Default layout - ADJUST AS NEEDED!
      position: "absolute",
      width: "60%",
      height: "37%",
      top: "56%",
  ...
  },
  {
    ...
    summary:
      "A client pitch: streamlining operations covering the candidate's approach to running a client pitch: streamlining operations, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
    category: "Virtual Communication",
    soundAsset: SOUND_VC,
...
This system not only speeds up processes but also provides real-time analytics, giving you unprecedented visibility into your operations. Our case studies with similar clients show an average ROI of 250% within the first year. We're confident FlowOptimize will deliver significant value and provide a competitive edge. Are there any specific concerns or areas you'd like us to elaborate on further?`, // Updated text
  ...
  },
  {
    ...
    summary:
      "A team brainstorm: new marketing initiative covering the candidate's approach to running a team brainstorm: new marketing initiative, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
    category: "Virtual Communication",
...
Let's start by throwing out some initial concepts. Don't worry about feasibility just yet; focus on creativity. I'll capture everything on the virtual whiteboard. Remember the rules: build on each other's ideas, encourage wild thoughts, and defer judgment. Who wants to get us started? What's the first idea that comes to mind for reaching this demographic?`, // Updated text
  ...
  },
  {
    ...
    summary:
      "A performance review discussion covering the candidate's approach to running a performance review discussion, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
    category: "Virtual Communication",
...
Looking forward, let's discuss development goals for the upcoming year. Based on your interest in leadership, I recommend focusing on project management skills. We can explore opportunities for you to lead smaller initiatives or shadow senior project managers. Let's also set a specific goal around enhancing your presentation skills for client-facing meetings. What are your thoughts on these areas?`, // Updated text
  ...
  },
  {
    ...
    summary:
      "A large group webinar: polling session covering the candidate's approach to running a large group webinar: polling session, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
    category: "Virtual Communication",
...
Your responses will help tailor the rest of the session to your needs and interests. Once everyone has responded, we'll display the aggregated results and proceed accordingly. Let's get started with Question 1.`,
  ...
  },
  {
    ...
    summary:
      "A video status update for internal team covering the candidate's approach to running a video status update for internal team, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
    category: "Virtual Communication",
...
Next up is the front-end integration and QA testing phase. If you have any blockers or need support, please drop a note in the project thread. I'll be reviewing all pending pull requests by end of day. Thanks again for staying on track — keep up the great work!`,
  ...
  },
  {
    ...
    summary:
      "A hotel-based remote check-in meeting covering the candidate's approach to running a hotel-based remote check-in meeting, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
    category: "Virtual Communication",
  ...
  // --- Situational/Specific Prompts ---
  {
    ...
    summary:
      "A conference networking recap covering the candidate's approach to running a conference networking recap, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
    category: "Virtual Communication",
  ...
  },
  {
    ...
    summary:
      "A training session wrap-up and reflection covering the candidate's approach to running a training session wrap-up and reflection, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
    category: "Virtual Communication",
  ...
  },
  {
    ...
    summary:
      "A global sync call: leadership check-in covering the candidate's approach to running a global sync call: leadership check-in, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
    category: "Virtual Communication",
  ...
  },
  {
    ...
    summary:
      "A pre-recorded course introduction covering the candidate's approach to running a pre-recorded course introduction, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
    category: "Virtual Communication",
  ...
  },
  {
    ...
    summary:
      "A one-on-one: career coaching session covering the candidate's approach to running a one-on-one: career coaching session, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
    category: "Virtual Communication",
  ...
  },
  {
    ...
    summary:
      "A live podcast recording covering the candidate's approach to running a live podcast recording, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
    category: "Virtual Communication",
  ...
  [
    {
      ...
      summary:
        "A virtual trivia night covering the candidate's approach to running a virtual trivia night, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
      category: "Virtual Communication",
    ...
    },
    {
      ...
      summary:
        "A team sync: project overview covering the candidate's approach to running a team sync: project overview, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
      category: "Virtual Communication",
    ...
    },
    {
      ...
      summary:
        "A reddit live AMA session covering the candidate's approach to running a reddit live AMA session, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
      category: "Virtual Communication",
    ...
    },
    {
      ...
      summary:
        "A clubhouse live audio panel covering the candidate's approach to running a clubhouse live audio panel, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
      category: "Virtual Communication",
    ...
    },
    {
      ...
      summary:
        "A horizon virtual meeting login covering the candidate's approach to running a horizon virtual meeting login, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
      category: "Virtual Communication",
    ...
    },
    {
      ...
      summary:
        "A discord screen sharing session covering the candidate's approach to running a discord screen sharing session, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
      category: "Virtual Communication",
    ...
    },
    {
      ...
      summary:
        "A live news broadcast covering the candidate's approach to running a live news broadcast, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
      category: "Virtual Communication",
    ...
    },
    {
      ...
      summary:
        "A streamyard live broadcast covering the candidate's approach to running a streamyard live broadcast, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
      category: "Virtual Communication",
    ...
    },
    {
      ...
      summary:
        "A video standup meeting covering the candidate's approach to running a video standup meeting, highlighting the importance of clear communication, and offering a solution to prevent the mistake from happening again.",
      category: "Virtual Communication",
