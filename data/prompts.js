...
import { 
  ...
  SOUND_PRESENTATION,
  SOUND_INTREVIEW,
  SOUND_SITUATIONAL_SPECIFIC,
  SOUND_SOCIAL_CASUAL,
  SOUND_VC,
  SOUND_SPEECH,
  SOUND_PRACTICE_FUNDAMENTAL,
} from './sounds';
...
export const promptsData = [
  ...
  // --- Practice Fundamentals Prompts ---
  {
    ...
    soundAsset: SOUND_PRACTICE_FUNDAMENTAL,
  ...
  // 3. Customize placeholder `title`, `text`, and `layout` for each prompt.
  {
    ...
    soundAsset: SOUND_SITUATIONAL_SPECIFIC,
  ...
  // 3. Customize placeholder `title`, `text`, and `layout` for each prompt.
  {
    ...
    soundAsset: SOUND_SOCIAL_CASUAL,
